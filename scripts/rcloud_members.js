...
var sendReq = function (u) {
	...
	options.path = path + '/users/' + db.users[u].id + '/organizations/' + pad(db.users[u].actor_id, 32) + '/applications/' 
		+ migration_config.cloud_app_id + '/roles/' + migration_config.cloud_app_member_role;
